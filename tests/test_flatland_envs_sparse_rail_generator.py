...
def test_sparse_rail_generator_deterministic():
    ...
    assert env.rail.get_full_transitions(6, 1) == 16386, "[6][1]"
    ...
    assert env.rail.get_full_transitions(6, 11) == 17411, "[6][11]"
    ...
    assert env.rail.get_full_transitions(7, 1) == 49186, "[7][1]"
    assert env.rail.get_full_transitions(7, 2) == 1025, "[7][2]"
    assert env.rail.get_full_transitions(7, 3) == 1097, "[7][3]"
    assert env.rail.get_full_transitions(7, 4) == 3089, "[7][4]"
    assert env.rail.get_full_transitions(7, 5) == 5633, "[7][5]"
    assert env.rail.get_full_transitions(7, 6) == 1025, "[7][6]"
    assert env.rail.get_full_transitions(7, 7) == 17411, "[7][7]"
    assert env.rail.get_full_transitions(7, 8) == 1097, "[7][8]"
    assert env.rail.get_full_transitions(7, 9) == 3089, "[7][9]"
    assert env.rail.get_full_transitions(7, 10) == 1025, "[7][10]"
    assert env.rail.get_full_transitions(7, 11) == 34864, "[7][11]"
    ...
    assert env.rail.get_full_transitions(8, 1) == 49186, "[8][1]"
    assert env.rail.get_full_transitions(8, 2) == 1025, "[8][2]"
    assert env.rail.get_full_transitions(8, 3) == 1025, "[8][3]"
    assert env.rail.get_full_transitions(8, 4) == 1025, "[8][4]"
    assert env.rail.get_full_transitions(8, 5) == 1097, "[8][5]"
    assert env.rail.get_full_transitions(8, 6) == 1025, "[8][6]"
    assert env.rail.get_full_transitions(8, 7) == 3089, "[8][7]"
    assert env.rail.get_full_transitions(8, 8) == 1025, "[8][8]"
    assert env.rail.get_full_transitions(8, 9) == 1025, "[8][9]"
    assert env.rail.get_full_transitions(8, 10) == 1025, "[8][10]"
    ...
    assert env.rail.get_full_transitions(9, 0) == 0, "[9][0]"
    ...
    assert env.rail.get_full_transitions(10, 0) == 0, "[10][0]"
    ...
    assert env.rail.get_full_transitions(11, 0) == 0, "[11][0]"
    assert env.rail.get_full_transitions(11, 1) == 72, "[11][1]"
    assert env.rail.get_full_transitions(11, 2) == 4608, "[11][2]"
    ...
    assert env.rail.get_full_transitions(11, 24) == 2064, "[11][24]"
    assert env.rail.get_full_transitions(12, 0) == 0, "[12][0]"
    assert env.rail.get_full_transitions(12, 1) == 0, "[12][1]"
    assert env.rail.get_full_transitions(12, 2) == 32800, "[12][2]"
    ...
    assert env.rail.get_full_transitions(13, 2) == 32800, "[13][2]"
    ...
    assert env.rail.get_full_transitions(14, 2) == 32800, "[14][2]"
    ...
    assert env.rail.get_full_transitions(15, 2) == 32800, "[15][2]"
    ...
    assert env.rail.get_full_transitions(16, 2) == 32800, "[16][2]"
    ...
    assert env.rail.get_full_transitions(17, 2) == 32800, "[17][2]"
    ...
    assert env.rail.get_full_transitions(18, 2) == 32800, "[18][2]"
    ...
    assert env.rail.get_full_transitions(19, 1) == 16386, "[19][1]"
    assert env.rail.get_full_transitions(19, 2) == 2064, "[19][2]"
    ...
    assert env.rail.get_full_transitions(19, 24) == 4608, "[19][24]"
    ...
    assert env.rail.get_full_transitions(23, 19) == 1025, "[23][19]"
    assert env.rail.get_full_transitions(23, 20) == 4608, "[23][20]"
    ...
    assert env.rail.get_full_transitions(24, 11) == 1025, "[24][11]"
    assert env.rail.get_full_transitions(24, 12) == 1025, "[24][12]"
    assert env.rail.get_full_transitions(24, 13) == 1025, "[24][13]"
    assert env.rail.get_full_transitions(24, 14) == 5633, "[24][14]"
    ...
    assert env.rail.get_full_transitions(24, 18) == 3089, "[24][18]"
    assert env.rail.get_full_transitions(24, 19) == 1025, "[24][19]"
    assert env.rail.get_full_transitions(24, 20) == 1097, "[24][20]"
    ...
    assert env.rail.get_full_transitions(25, 14) == 72, "[25][14]"
    ...
    assert env.rail.get_full_transitions(25, 18) == 5633, "[25][18]"
    assert env.rail.get_full_transitions(25, 19) == 1025, "[25][19]"
    assert env.rail.get_full_transitions(25, 20) == 17411, "[25][20]"
    ...
    assert env.rail.get_full_transitions(26, 18) == 72, "[26][18]"
    assert env.rail.get_full_transitions(26, 19) == 1025, "[26][19]"
    assert env.rail.get_full_transitions(26, 20) == 2064, "[26][20]"
